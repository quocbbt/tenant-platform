    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (authorization != null && authorization.startsWith(SecurityConstants.BEARER_PREFIX)) {
                ...
                if (tenantHeader != null && !tenantHeader.isBlank() && tenantCode != null && !tenantHeader.equals(tenantCode)) {
                    response.setStatus(HttpServletResponse.SC_FORBIDDEN);
                    response.getWriter().write("{\"code\":\"TENANT_FORBIDDEN\",\"message\":\"Tenant code is invalid or not allowed\"}");
                    return;
                }
